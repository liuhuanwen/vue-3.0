<template>
  <div class="item-wrapper">
        ...
        <section class="shop-rate">
          <div class="rate-wrapper">
            <div class="rate">
              ...
              <div
                class="rate-actived"
                :style="{ width: `${(foodShop.rating / 5) * 100}%` }"
              >
          ...
          <span v-show="foodShop.delivery_mode" class="span-right"
            >蜂鸟专送</span
          >
        </section>
        <section class="shop-money-distance">
          <span class="money-limit"
            >¥{{ foodShop.float_minimum_order_amount }}起送 | 配送费¥{{
              foodShop.float_delivery_fee
            }}</span
          >
          <span class="distance-time"
            >{{ shopDistance }} |
            {{ foodShop.float_minimum_order_amount }}分钟</span
          >
        </section>
      </div>
    </div>
    <div class="activity-wrapper">
      <div class="tag">
        <span v-for="(item, index) in foodShop.flavors" :key="index">{{
          item.name
        }}</span>
      </div>
      <div class="activity-list-wrapper">
        <div class="activity-list">
          <div
            ...
            v-if="index < 2 || isShowMoreActivities"
            :key="index"
          >
            <span
              class="icon"
        ...
        >
          ...
          <svg
            ...
            :class="{ 'icon-arrow-bottom-transform': isShowMoreActivities }"
